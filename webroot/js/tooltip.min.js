...
class e {
    ...
    _scheduleHide(a, b, c, d) {
        ...
        window.setTimeout(() => {
            if ((window.clearTimeout(this._showTimeout), !1 !== this._isOpen) && document.body.contains(this._tooltipNode)) {
    ...
    _updateTitleContent(a) {
        ...
        const b = this._tooltipNode.parentNode.querySelector(this.options.innerSelector);
